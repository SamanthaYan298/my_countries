          ...
          {countries.map((country, index) => (
            <div kry={index}>
              <div>
                ...
                <div>
                  <p><strong>Offical name: </strong>{country.name > official/common}</p>
                  <p><strong>Capital: </strong>{country.capital}</p>
                  <p><strong>Population: </strong>{country.population}</p>
                  <p><strong>Languages: </strong>{country.population}</p>
                  <p><strong>Currency: </strong>{country.population}</p>
                  <p><strong>Area (mi2): </strong>{country.population}</p>
                  <p><strong>Subregion: </strong>{country.population}</p>
                  <p><strong>Continents: </strong>{country.population}</p>
                  <p><strong>Borders: </strong>{country.population}</p>
                </div>
              </div>
